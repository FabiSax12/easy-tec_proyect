...
export default function CoursesMainTable() {
  ...
  const renderCell = React.useCallback((course: Course, columnKey: React.Key) => {
    ...
    switch (columnKey) {
      ...
      case "state":
        return (
          <Chip className="capitalize" color={statusColorMap[course.state]} size="sm" variant="flat">
            {cellValue}
          </Chip>
        );
      case "actions":
        return (
          <div className="relative flex justify-end items-center gap-2">
            <Dropdown>
              ...
              <DropdownMenu>
                <DropdownItem color="primary" variant="light">Abrir</DropdownItem>
                <DropdownItem color="success" variant="light">Editar</DropdownItem>
                <DropdownItem className="text-danger" color="danger" variant="solid">Eliminar</DropdownItem>
              </DropdownMenu>
            </Dropdown>
          </div>
        );
